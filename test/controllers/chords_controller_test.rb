...
class ChordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chord" do
    assert_difference('Chord.count') do
      post chords_url, params: { chord: { artist: @chord.artist, chords: @chord.chords, page_url: @chord.page_url, song: @chord.song } }
    end
  ...
  test "should update chord" do
    patch chord_url(@chord), params: { chord: { artist: @chord.artist, chords: @chord.chords, page_url: @chord.page_url, song: @chord.song } }
